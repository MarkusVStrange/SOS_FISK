...
write.table(sealFood,"Sealfood_sim.csv",row.names = FALSE,sep=';')
write.table(cormFood,paste(data_wd,"Sealfood_sim_quarter.csv",sep=""),row.names = FALSE,sep=';')
...
write.table(cormFood,paste(data_wd,"Cormfood_sim_quarter.csv",sep=""),row.names = FALSE,sep=';')
#####
