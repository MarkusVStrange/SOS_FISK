...
sealFood <- read.table(paste(data_wd,"sealFood_month.csv",sep=""),header=TRUE,sep=';')
...
meanS.B <- c(12085951.33,19036.47) # means from the food time series in "prepareDirichletDiet"
