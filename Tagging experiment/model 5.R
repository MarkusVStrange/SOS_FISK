...
x1 <- plogis(-1.48927007+0.23788884) # 11-15cm cod April 2022
x2 <- plogis(-1.48927007-0.15107790) # 11-15cm cod April 2024
x1
x2
odds1 <- x1/(1-x1) # probability of success/probability of failure
odds2 <- x2/(1-x2)
odds1
odds2
odds1*exp(-0.15107790-0.23788884)
odds2*exp(0.23788884--0.15107790)
...
df <- data.frame(species = rep(c("cod","flounder"),each=5*4*2),
                 ...
                 est = c(est$codMarch22,est$codApril22,est$codMay22,est$codJune22,
                         est$codMarch24,est$codApril24,est$codMay24,est$codJune24,
                         est$flounderMarch22,est$flounderApril22,est$flounderMay22,est$flounderJune22,
                         est$flounderMarch24,est$flounderApril24,est$flounderMay24,est$flounderJune24),
                 sd = c(sd$codMarch22,sd$codApril22,sd$codMay22,sd$codJune22,
                        sd$codMarch24,sd$codApril24,sd$codMay24,sd$codJune24,
                        sd$flounderMarch22,sd$flounderApril22,sd$flounderMay22,sd$flounderJune22,
                        sd$flounderMarch24,sd$flounderApril24,sd$flounderMay24,sd$flounderJune24))
